...
This is a API only project, frontend side was already provided.

### Server Boilerplate

In **server.js**, things I have done:
...
The **server/db.js** file exports helper functions for working with the database arrays. The goal of this project is for me to focus on Express routes and not worry about how the database works under the hood. These functions always take at least one argument, and the first argument is always a string representing the name of the database model: `'minions'`, `'ideas'`, `'meetings'`, or `'work'`.

So these are the helper functions that were provided:
